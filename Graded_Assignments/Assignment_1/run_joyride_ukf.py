"""
File name: run_joyride_ukf.py

Creation Date: Mo 19 Okt 2020
...
init_ukf_CV_state = GaussParams(mean_init_CV, cov_init_CV)
init_ukf_CT_state = GaussParams(mean_init_CT, cov_init_CT)

init_states = [init_ukf_CV_state, init_ukf_CT_state]
...
ukf_filters = []
ukf_filters.append(ukf.UKF(dynamic_models[0], measurement_model))
ukf_filters.append(ukf.UKF(dynamic_models[1], measurement_model))

tracker_UKF_CV = pda.PDA(ukf_filters[0], clutter_intensity, PD, gate_size)
tracker_UKF_CT = pda.PDA(ukf_filters[1], clutter_intensity, PD, gate_size)

trackers = [tracker_UKF_CV, tracker_UKF_CT]
...
tracker_update_CV = init_ukf_CV_state
tracker_update_list_CV = []
tracker_predict_list_CV = []
tracker_estimate_list_CV = []

tracker_update_CT = init_ukf_CT_state
